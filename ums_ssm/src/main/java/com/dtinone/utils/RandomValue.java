...
public class RandomValue {
     ...
     * @return
     */
    public static String getEmail(int minLength, int maxLength) {
        int length = getNum(minLength, maxLength);
    ...
    public static String randomBirthday() {
        ...
        builder.append(birthday.get(Calendar.YEAR) + "-");//拼接年-
        long month = birthday.get(Calendar.MONTH) + 1;
        if (month < 10) {
            builder.append("0");
        }
        builder.append(month + "-"); //拼接月-
        long date = birthday.get(Calendar.DATE);
        if (date < 10) {
            builder.append("0");
        }
        builder.append(date);//拼接日
     ...
     */
    public static char idCardNumber(char[] chars) {
        if (chars.length < 17) {
            return ' ';
        }
    ...
    public static void main(String[] args) {
        System.out.println(RandomValue.getEmail(3, 18));

        System.out.println(RandomValue.getChineseName());

        System.out.println(RandomValue.getMobile());
