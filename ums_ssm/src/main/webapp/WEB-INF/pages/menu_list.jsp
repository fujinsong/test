...
<head>
    ...
    <%--    <script type="text/javascript" src="${ctx_modules}js/menu_list.js"></script>--%>
</head>
<body>
    <ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}menu/list">权限列表</a></li>
    <li><a href="${ctx}menu/form">权限添加</a></li>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="unit">
        <tr>
            <td><a href="${ctx}menu/form?id=${unit.id}">${unit.name}</a></td>
            <td>${unit.url}</td>
            <td>
            ...
            <td>
                <a href="${ctx}menu/form?id=${unit.id}">修改</a>
                <a class="delete_data" name="menu" title="${unit.id}" href="javascript:void(0)">删除</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
